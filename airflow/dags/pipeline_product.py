...
# AUTO-GENERATED — pipeline: product
# Do not manually edit. Use /create_pipeline endpoint to regenerate.

PIPELINE_ID     = "pipeline_product"
CONNECTOR_TYPE  = "csv"
FOLDER_PATH     = "E:/Universal_data_connector_system/Dataset/test"
FILE_PATH       = None
SHEET_URL       = None
API_URL         = None
OPTION          = "1"
...
DATASET_PIPELINE_CON = "/opt/airflow/dataset/pipeline_product"
PIPELINE_CON_ROOT    = "/opt/airflow/user_data/pipeline_product"
